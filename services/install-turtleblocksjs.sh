...
function get_icon {
  cat <<EOF
<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="100" height="100" viewBox="0 0 55 55" style="fill:#fff;stroke:#000;stroke-width:1.5;stroke-linecap:round;stroke-linejoin:round">
  <defs/>
  ...
  <circle cx="59.484001" cy="37.223999" r="1.109" transform="translate(-6.9147758 -8.3090122) scale(.9264)" style="stroke-width:1.18739116;stroke-miterlimit:4;stroke-dasharray:none"/>
  <g transform="matrix(1.03209 0 0 .99905 -.184081 .02418615)">
